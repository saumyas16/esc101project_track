...
echo "<h3>" .'Practice:'."&nbsp;&nbsp;&nbsp;&nbsp;<button class=\"button\" style=\"vertical-align:middle\" onClick=\"f6()\"><span>Challenges</span></button>". "</h3>";
